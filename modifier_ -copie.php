...
<!-- LE PANNEAU DE GAUCHE :  -->
  ...
  <table class="tablegauche" style="top:76.5px;" name="listes" > 
	 ...
	 <tr><td> Acte   </td> <td> <input type="text" name="acte"                    value="<?php echo $donnees["acte"];?>" required></td></tr>
	 ...
	 <tr><td> D&eacute;livr&eacute; &agrave; </td> <td> <input type="text" name="delivre_a" value="<?php echo $donnees["delivre_a"];?>" required ></td></tr>
	 <tr><td> Le  </td> <td> <input type="text" name="delivre_le" value="<?php echo $donnees["delivre_le"];?>"  required ></td></tr>
	 <tr><td> L'an  </td> <td> <input type="text" name="delivre_an"  value="<?php echo $donnees["delivre_an"];?>" required > </td></tr>
	 <tr><td> S&eacute;rie Num  </td> <td> <input type="text" name="num_serie" value="<?php echo $donnees["num_serie"];?>" required  ></td></tr>
 </table>
